...
I am a first-year Ph.D. student at [University of California, Los Angeles](https://www.ucla.edu/)'s Department of Computer Science, fortunate to be advised by [Professor Wei Wang](http://web.cs.ucla.edu/~weiwang/).
...
- Infer information-rich properties (e.g. structure) from primary properties (e.g. sequences).
- Model interactions among molecules (protein/ligand/DNA) and make drug discovery more *directed*.
